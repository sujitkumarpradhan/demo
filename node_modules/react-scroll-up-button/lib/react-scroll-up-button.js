...
var ScrollUpButton = (function(_React$Component) {
    ...
    function ScrollUpButton(props) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(
            this,
            (
                ScrollUpButton.__proto__ ||
                (0, _getPrototypeOf2.default)(ScrollUpButton)
            ).call(this, props)
        );
    ...
    (0, _createClass3.default)(ScrollUpButton, [
        {
            ...
            value: function HandleScroll() {
                ...
                if (window.pageYOffset > this.props.ShowAtPostion) {
                    ...
                    this.setState({
                        ToggleScrollUp: this.props.TransitionClassName
                    });
                } else {
        ...
        },
        {
            ...
            value: function ScrollingFrame() {
                ...
                if (window.pageYOffset <= this.props.StopPosition) {
                    ...
                    var YPos = _tweenFunctions2.default[this.props.EasingType](
                        this.Animation.CurrentAnimationTime,
        ...
        },
        {
            ...
            value: function componentDidMount() {
                ...
                window.addEventListener(
                    "wheel",
                    this.StopScrollingFrame,
                    _detectPassiveEvents2.default.hasSupport
                        ? { passive: true }
                        : false
...
ScrollUpButton.propTypes = {
    ...
    EasingType: _propTypes2.default.oneOf([
        "linear",
        "easeInQuad",
        "easeOutQuad",
        "easeInOutQuad",
